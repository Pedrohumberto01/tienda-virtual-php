              ...
              <table class="table table-bordered">
                <tbody>
                  <tr>
                    ...
                    <td id="celIdentificacion">888888888</td>
                  </tr>
                  <tr>
                    <td>Nombres:</td>
                    <td id="celNombre">Pedro Humberto</td>
                  </tr>
                  <tr>
                    <td>Apellidos:</td>
                    <td id="celApellido">Romero Colindres</td>
                  </tr>
                  <tr>
                    <td>Telefono::</td>
                    <td id="celTelefono">82930058</td>
                  </tr>
                  <tr>
                    <td>Email:</td>
                    <td id="celEmail">pcolindres8@gmail.com</td>
                  </tr>
                  <tr>
                    <td>Tipo Usuario:</td>
                  ...
                  <tr>
                    ...
                    <td id="celFechaRegistro">01-01-2023</td>
                  </tr>
                </tbody>
              </table>
            </div>
