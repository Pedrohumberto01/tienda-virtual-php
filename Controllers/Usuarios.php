<?php 
	...
	class Usuarios extends Controllers{
		...
		public function Usuarios()
		{
			...
			$data['page_functions_js'] = "funtions_usuarios.js";
		...
		public function getUsuarios()
		{
			...
			for ($i=0; $i < count($arrData); $i++) {
				...
				<button class="btn btn-success  btn-sm btnEditUsuario" onClick=fntEditUsuario('.$arrData[$i]['idpersona'].') title="Editar usuario"><i class="fas fa-pencil-alt"></i></button>
		...
		public function delUsuario()
		{
			if($_POST)
			{
				...
				$request_delete = $this->model->deleteUsuario($intIdPersona);
				if($request_delete)
				{
