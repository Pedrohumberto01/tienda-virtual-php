<?php 
	...
	class Roles extends Controllers{
		...
		public function Roles()
		{
			...
			$data['page_functions_js'] = "funtions_roles.js";
		...
		public function getRoles()
		{
			...
			for($i=0; $i<count($arrData); $i++)
			{
				...
				<button class="btn btn-success btn-sm btnEditRol" onClick="fntEditRol('.$arrData[$i]['idrol'].')" title="Editar"><i class="fas fa-pencil-alt"></i></button>
